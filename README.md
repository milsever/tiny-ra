...
```bash
onager prelaunch +jobname mt_hard_1000 resnet50-das.42 --result-dir mt_search_hard_ops/1000 --arch resnet34 --learning-method mean-teacher -e 75 -bs 16 --ubs 64 -lr 0.01 --lr-sched --optimizer SGD --ema-decay 0.99 --consistency-type mse --consistency 500 --consistency-rampup 10 --seed 1000 --num-workers 8 --num-labels 0.1 --meta-cat snacks +arg --color-op Bri Sat Con Hue Blur Sharp Post Solar Equal --geom-op ShearX ShearY TranslateX TranslateY Rotate
```
...
**Figure 13 (a)** Min-loss Policy (semi-supervised\policy_learn_arf\000-resnet18-cifar10-e_75-mtrandA_20p.1000.5281604) =>
...
**Figure 13 (b)** Max-loss Policy (semi-supervised\policy_learn_arf\001-resnet18-cifar10-e_75-mtrandA_20p.1000.5281618) =>
